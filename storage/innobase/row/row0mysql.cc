        ...
        row_prebuilt_t* prebuilt)/*!< in: use prebuilt->compress_heap only here*/
{
        ...
        default:
                ...
                fprintf(stderr, "Innodb: failed to compress the column, error:%d\n", err);
        }
        ...
        row_prebuilt_t* prebuilt) /*!< in: use prebuilt->compress_heap only here*/
{
        ...
        case Z_BUF_ERROR:
                ut_print_timestamp(stderr);
                fprintf(stderr, "Innodb: zlib buf error, this shouldn't happen\n");
                break;
        default:
                ut_print_timestamp(stderr);
                fprintf(stderr, "Innodb: failed to decompress column, error:%d\n", err);
        }
        ...
        if (err == Z_OK)
        {
                *len = buf_len;
                ...
                {
                        ut_print_timestamp(stderr);
                        fprintf(stderr, "Innodb: failed to decompress blob column, may be corrupted\n");
                        ut_a(0);
                }
        ...
        ut_print_timestamp(stderr);
        fprintf(stderr, "Innodb: failed to decompress column, this shouldn't happen!\n");
